            ...
            <div class="absolute-text">
                <div class="container">
                    <div class="main-txt pt-5">
                        <p>
                            O Instituto Roki foi criado para acolher mulheres com Síndrome<br>
                            de Rokitansky, e seus familiares, compartilhando vivências e<br>
                            informações sempre atualizadas, em parceria com profissionais<br>
                            da área da saúde. Entendemos os processos e as emoções<br>
                    ...
                    <div class=" col-md-4 p-0-620">
                        <div class="main-aside">
                            <div class="aside-title paddingo-b-aside">
                                <h4 class="head-4-2 mb-0">Programe-se</h4>
                                <span>Participe e convide seus familiares</span>
                            </div>
